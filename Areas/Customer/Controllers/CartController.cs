...
namespace BulkyBookV5.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public IActionResult Plus(int cartId)
        {
            ...
            cart.Count += 1;
            cart.Price = SD.GetrPriceBasedOnQuantity(cart.Count, cart.Product.Price, cart.Product.Price50, cart.Product.Price100);
            _unitOfWork.Save();
        ...
        public IActionResult SummaryPost(string stripeToken)
        {
            ...
            {
                item.Price = SD.GetrPriceBasedOnQuantity(item.Count, item.Product.Price, item.Product.Price50, item.Product.Price100);
            ...
            if (stripeToken == null)
            {
                //Order will be creatd for delayed payment for authorized company
