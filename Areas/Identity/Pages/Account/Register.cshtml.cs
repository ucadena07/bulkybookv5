...
namespace BulkyBookV5.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (!await _roleManager.RoleExistsAsync(SD.Role_Role_Comp))
                    {
                        await _roleManager.CreateAsync(new IdentityRole(SD.Role_Role_Comp));
                    }
                    ...
                    else
                    {
                        if(user.CompanyId > 0)
                        {
                            await _userManager.AddToRoleAsync(user, SD.Role_Role_Comp);
                        }
                        else
                        {
